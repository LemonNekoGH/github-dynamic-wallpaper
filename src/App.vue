<template>
  <div class="content" :style="{
    ...
    <svg class="svg-img" aria-hidden="true" viewBox="0 0 273 147" stroke-width="3" stroke-linecap="round"
      ...
      <g>
        ...
        <path :stroke="hillsColor" d="M132.001 124.5c-5.999 6-.999 10.999 4.999 4.999 5.999-6 1-10.999-4.999-4.999z" />
      </g>
      <g>
...
// 是否强制白天
const forceTheme = ref<'auto' | 'day' | 'night'>('auto')
// 是否是白天
const isDayTime = computed(() => {
  if (forceTheme.value === 'day') return true;
  if (forceTheme.value === 'night') return false;
